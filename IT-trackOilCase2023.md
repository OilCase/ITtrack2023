...
<details>
    ...
    <details style="margin-left: 32px">
        ...
        Большая часть информации, с которой работают инженеры, хранится в табличном виде. Традиционно, формат файлов -это *excel*, *csv*, *txt.* Библиотеки 

[Pandas](https://pandas.pydata.org/docs/index.html) и Numpy - это базовые инструменты-интерфейсы для работы с файлами.
